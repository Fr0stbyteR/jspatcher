...
/***/ "./dsps lazy recursive ^\\.\\/.*\\/dspMeta\\.json$":
/*!*************************************************************!*\
  !*** ./dsps/ lazy ^\.\/.*\/dspMeta\.json$ namespace object ***!
  \*************************************************************/
...
/***/ "./dsps lazy recursive ^\\.\\/.*\\/dspModule\\.wasm$":
/*!***************************************************************!*\
  !*** ./dsps/ lazy ^\.\/.*\/dspModule\.wasm$ namespace object ***!
  \***************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
/***/ "./node_modules/@shren/faustwasm/dist/index.js":
/*!*****************************************************!*\
  !*** ./node_modules/@shren/faustwasm/dist/index.js ***!
  \*****************************************************/
/***/ ((module, exports, __webpack_require__) => {

var __WEBPACK_AMD_DEFINE_RESULT__;var __create = Object.create;
...
var instantiateFaustModule = async (jsFile, dataFile = jsFile.replace(/c?js$/, "data"), wasmFile = jsFile.replace(/c?js$/, "wasm")) => {
  let LibFaust2;
  try {
    LibFaust2 = __webpack_require__("./node_modules/@shren/faustwasm/dist sync recursive")(jsFile);
  } catch (error) {
...
/***/ "./node_modules/@shren/faustwasm/dist sync recursive":
/*!**************************************************!*\
  !*** ./node_modules/@shren/faustwasm/dist/ sync ***!
  \**************************************************/
/***/ ((module) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async () => {
  const dsps = {};
  const listIn = await __webpack_require__.e(/*! import() */ "dsps_dsps_json").then(__webpack_require__.t.bind(__webpack_require__, /*! ../dsps/dsps.json */ "./dsps/dsps.json", 17));
  const list = JSON.parse(listIn.default);
  for (const dspId of list) {
    const moduleUri = (await __webpack_require__("./dsps lazy recursive ^\\.\\/.*\\/dspModule\\.wasm$")(`./${dspId}/dspModule.wasm`)).default;
    const moduleRes = await fetch(moduleUri);
    const module = await WebAssembly.compileStreaming(moduleRes);
    const json = (await __webpack_require__("./dsps lazy recursive ^\\.\\/.*\\/dspMeta\\.json$")(`./${dspId}/dspMeta.json`)).default;
    dsps[dspId] = {
      module,
      json
    };
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _shren_faustwasm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @shren/faustwasm */ "./node_modules/@shren/faustwasm/dist/index.js");
/* harmony import */ var _shren_faustwasm__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_shren_faustwasm__WEBPACK_IMPORTED_MODULE_0__);
