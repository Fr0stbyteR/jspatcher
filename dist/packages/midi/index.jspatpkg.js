...
/* harmony export */ });
/* harmony import */ var _sdk__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../sdk */ "./src/sdk.ts");
/* harmony import */ var _worklets_MidiSequencerNode__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../worklets/MidiSequencerNode */ "./src/worklets/MidiSequencerNode.ts");
/* harmony import */ var _Base__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Base */ "./src/objects/Base.ts");



class midiSequencer extends _Base__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor() {
    super(...arguments);
    this._ = { node: null };
  }
  subscribe() {
    ...
    this.on("postInit", async () => {
      await _worklets_MidiSequencerNode__WEBPACK_IMPORTED_MODULE_1__["default"].register(this.audioCtx);
      const node = new _worklets_MidiSequencerNode__WEBPACK_IMPORTED_MODULE_1__["default"](this.audioCtx);
      ...
      node.onEnd = () => this.outlet(1, new _sdk__WEBPACK_IMPORTED_MODULE_0__.Bang());
      this._.node = node;
    });
    this.on("updateProps", () => {
...
class MidiSequencerNode extends AudioWorkletNode {
  ...
  constructor(context) {
    ...
    this.handleMessage = (e) => {
      ...
      if (e.data.type === "midiMessage") {
        (_a = this.onMidi) == null ? void 0 : _a.call(this, e.data.data.bytes, e.data.data.time);
      } else if (e.data.type === "timeOffset") {
        this.timeOffset = e.data.data;
      } else if (e.data.type === "end") {
        (_b = this.onEnd) == null ? void 0 : _b.call(this);
      }
    };
  ...
  sendFlush() {
    var _a, _b;
    (_a = this.onMidi) == null ? void 0 : _a.call(this, new Uint8Array([176, 121, 0]), this.context.currentTime);
    (_b = this.onMidi) == null ? void 0 : _b.call(this, new Uint8Array([176, 123, 0]), this.context.currentTime);
  }
  destroy() {
    this.sendFlush();
  }
