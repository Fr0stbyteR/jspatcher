...
class AudioRecorder {
  ...
  async start() {
    ...
    if (overwrittenBufferLength) this.overwrittenAudio = await _PatcherAudio__WEBPACK_IMPORTED_MODULE_1__.default.fromSilence({
      env,
      file: file,
      project
    }, numberOfChannels, overwrittenBufferLength, sampleRate);else this.overwrittenAudio = undefined;
    this.recording = true;
...
module.exports = __webpack_require__.p + "js/318674d62311a313d6cb.worklet.js";
...
module.exports = __webpack_require__.p + "js/8cbeab044108fd756400.worklet.js";
