...
class History extends _utils_TypedEventEmitter__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    ...
    this.handleEditorEvent = async (eventName, eventData, editor) => {
      ...
      const event = { eventName, eventData, timestamp: this.now, editorId: editor.editorId, fileId: (_a = editor.file) == null ? void 0 : _a.id, username: this.username };
  ...
  get username() {
    return this.editors.values().next().value.env.username;
  }
  addEditor(editor) {
  ...
  async mergeEvents(...events) {
    ...
    if (!events.length)
      return [];
    const now = ((_a = this.eventQueue[this.$]) == null ? void 0 : _a.timestamp) || Infinity;
...
/******/ })()
;
//# sourceMappingURL=8d4a9b506947ce73689e.worklet.js.map