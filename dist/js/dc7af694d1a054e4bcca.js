...
class v extends StdObject {
  ...
  subscribe() {
    ...
    this.on("updateArgs", async args => {
      ...
      if (key !== this.state.key) {
        ...
        if (typeof args[1] !== "undefined") {
          ...
          (_this$state$sharedIte3 = this.state.sharedItem) === null || _this$state$sharedIte3 === void 0 ? void 0 : _this$state$sharedIte3.save(this.state.value, this);
        }
      }
    });
    ...
    this.on("inlet", (_ref12) => {
      ...
      if (inlet === 0) {
        if (!(0,_Base__WEBPACK_IMPORTED_MODULE_1__.isBang)(data)) {
          var _this$state$sharedIte4;

          this.setState({
            value: data
          });
          (_this$state$sharedIte4 = this.state.sharedItem) === null || _this$state$sharedIte4 === void 0 ? void 0 : _this$state$sharedIte4.save(this.state.value, this);
        }

        this.outlet(0, this.state.value);
      } else if (inlet === 1) {
        var _this$state$sharedIte5;

        this.setState({
          value: data
        });
        (_this$state$sharedIte5 = this.state.sharedItem) === null || _this$state$sharedIte5 === void 0 ? void 0 : _this$state$sharedIte5.save(this.state.value, this);
      } else if (inlet === 2) {
...
//# sourceMappingURL=dc7af694d1a054e4bcca.js.map