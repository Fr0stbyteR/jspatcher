...
class v extends StdObject {
  ...
  subscribe() {
    ...
    const unsubscribeItem = async () => {
      ...
      await ((_this$state$sharedIte3 = this.state.sharedItem) === null || _this$state$sharedIte3 === void 0 ? void 0 : _this$state$sharedIte3.removeObserver(this));
    };
...
//# sourceMappingURL=f80adb8c18500756ee33.js.map