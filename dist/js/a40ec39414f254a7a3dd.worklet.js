...
class TemporalAnalyserProcessor extends _AudioWorkletProxyProcessor__WEBPACK_IMPORTED_MODULE_2__.default {
  ...
  getEstimatedFreq(threshold, probabilityThreshold) {
    return this.window.map(ch => (0,_utils_yin__WEBPACK_IMPORTED_MODULE_1__.default)(ch, {
      sampleRate,
      threshold,
  ...
  process(inputs, outputs, parameters) {
    ...
    for (let i = 0; i < input.length; i++) {
      ...
      if (!this.window[i]) {
        ...
        if (this.window[i].length !== windowSize) {
          ...
          $ = (0,_utils_buffer__WEBPACK_IMPORTED_MODULE_0__.setTypedArray)(window, oldWindow, 0, $ - Math.min(windowSize, oldWindowSize));
    ...
    for (let i = 0; i < input.length; i++) {
      ...
      if (bufferSize > windowSize) {
        ...
        $ = (0,_utils_buffer__WEBPACK_IMPORTED_MODULE_0__.setTypedArray)(window, channel, $);
      }
    }
...
/******/ })()
;
//# sourceMappingURL=a40ec39414f254a7a3dd.worklet.js.map