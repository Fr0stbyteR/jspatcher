...
class ForIn extends StdObject {
  ...
  subscribe() {
    ...
    this.on("inlet", (_ref4) => {
      ...
      if (inlet === 0) {
        if (!Object(_Base__WEBPACK_IMPORTED_MODULE_1__["isBang"])(data)) this.state.buffer = data;
...
class lambda extends StdObject {
  ...
  subscribe() {
    ...
    this.on("inlet", (_ref12) => {
      ...
      if (inlet === 0) {
        if (Object(_Base__WEBPACK_IMPORTED_MODULE_1__["isBang"])(data)) this.outlet(0, this.lambda);
...
class call extends _Base__WEBPACK_IMPORTED_MODULE_1__["DefaultObject"] {
  ...
  subscribe() {
    ...
    this.on("inlet", (_ref14) => {
      ...
      if (inlet === 0) {
        if (!Object(_Base__WEBPACK_IMPORTED_MODULE_1__["isBang"])(data)) this.state.instance = data;
...
//# sourceMappingURL=89dd24ac20f5d81fda9b.js.map