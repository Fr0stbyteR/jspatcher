...
_defineProperty(BaseObject, "package", "base");
...
class comment extends _BaseObject__WEBPACK_IMPORTED_MODULE_0__.default {
  subscribe() {
    ...
    this.on("updateArgs", args => {
      if (!this.data.hasOwnProperty("value")) this.setData({
        value: args.join(" ")
      });
    });
    this.on("inlet", _ref => {
...
_defineProperty(comment, "description", "Text Comment");

_defineProperty(comment, "args", [{
  type: "string",
  optional: true,
  varLength: true,
...
const getRuler = (range, unit, _ref3) => {
  let {
    sampleRate = 48000,
    bpm = 60,
    beatsPerMeasure = 4,
  ...
  if (unit === "sample") {
    ...
    do {
      const grid = actualUnit === "ms" ? sampleRate * msFactors[step] / 1000 : actualUnit === "s" ? sampleRate * sFactors[step] : actualUnit === "min" ? sampleRate * minFactors[step] * 60 : sampleRate * hFactors[step] * mag * 60;
  ...
  while (m * refined < range[1]) {
    ...
    if (t && t % coarse < 0.001 || coarse - t % coarse < 0.001) {
      ruler[t] = unit === "sample" ? t.toString() : convertSampleToUnit(t, unit, {
        sampleRate,
        bpm,
        beatsPerMeasure,
        division
...
/******/ })()
;
//# sourceMappingURL=7f6b8d415915aa46eea1.worklet.js.map