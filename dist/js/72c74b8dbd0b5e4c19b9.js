...
class v extends StdObject {
  ...
  subscribe() {
    ...
    this.on("updateArgs", async args => {
      ...
      if (key !== this.state.key) {
        ...
        if (typeof args[1] !== "undefined") {
          var _this$state$sharedIte3, _this$state$sharedIte4;

          this.setState({
            value: args[1]
          });
          (_this$state$sharedIte3 = this.state.sharedItem) === null || _this$state$sharedIte3 === void 0 ? void 0 : (_this$state$sharedIte4 = _this$state$sharedIte3.save) === null || _this$state$sharedIte4 === void 0 ? void 0 : _this$state$sharedIte4.call(_this$state$sharedIte3, this.state.value, this);
        }
      }
    });
    ...
    this.on("inlet", (_ref10) => {
      ...
      if (inlet === 0) {
        if (!(0,_Base__WEBPACK_IMPORTED_MODULE_1__.isBang)(data)) {
          var _this$state$sharedIte5, _this$state$sharedIte6;

          this.setState({
            value: data
          });
          (_this$state$sharedIte5 = this.state.sharedItem) === null || _this$state$sharedIte5 === void 0 ? void 0 : (_this$state$sharedIte6 = _this$state$sharedIte5.save) === null || _this$state$sharedIte6 === void 0 ? void 0 : _this$state$sharedIte6.call(_this$state$sharedIte5, this.state.value, this);
        }

        this.outlet(0, this.state.value);
      } else if (inlet === 1) {
        var _this$state$sharedIte7, _this$state$sharedIte8;

        this.setState({
          value: data
        });
        (_this$state$sharedIte7 = this.state.sharedItem) === null || _this$state$sharedIte7 === void 0 ? void 0 : (_this$state$sharedIte8 = _this$state$sharedIte7.save) === null || _this$state$sharedIte8 === void 0 ? void 0 : _this$state$sharedIte8.call(_this$state$sharedIte7, this.state.value, this);
      } else if (inlet === 2) {
...
//# sourceMappingURL=72c74b8dbd0b5e4c19b9.js.map