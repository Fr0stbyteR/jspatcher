(window["webpackJsonpJSPatcher"] = window["webpackJsonpJSPatcher"] || []).push([[16],{

/***/ "./src/core/objects/Std.tsx":
/*!**********************************!*\
  !*** ./src/core/objects/Std.tsx ***!
  \**********************************/
/*! exports provided: call, default */
...
class loadbang extends StdObject {
  subscribe() {
    ...
    this.on("preInit", () => {
      this.inlets = 1;
      this.outlets = 1;
      this.patcher.on("ready", () => this.outlet(0, new _Base__WEBPACK_IMPORTED_MODULE_1__["Bang"]()));
    });
  }
...
class ForIn extends StdObject {
  ...
  subscribe() {
    ...
    this.on("inlet", (_ref4) => {
      ...
      if (inlet === 0) {
        if (!(data instanceof _Base__WEBPACK_IMPORTED_MODULE_1__["Bang"])) this.state.buffer = data;
  ...
  subscribe() {
    ...
    const reload = key => {
      ...
      if (key) {
        ...
        if (shared !== _utils_symbols__WEBPACK_IMPORTED_MODULE_2__["SharedDataNoValue"]) this.state.value = shared;else this.sharedData.set(sharedDataKey, key, this.state.value, this);
    ...
    this.on("sharedDataUpdated", (_ref11) => {
      let {
        data
      } = _ref11;
...
class lambda extends StdObject {
  ...
  subscribe() {
    ...
    this.on("inlet", (_ref12) => {
      ...
      if (inlet === 0) {
        if (data instanceof _Base__WEBPACK_IMPORTED_MODULE_1__["Bang"]) this.outlet(0, this.lambda);
...
class call extends _Base__WEBPACK_IMPORTED_MODULE_1__["DefaultObject"] {
  ...
  subscribe() {
    ...
    this.on("inlet", (_ref14) => {
      ...
      if (inlet === 0) {
        if (!(data instanceof _Base__WEBPACK_IMPORTED_MODULE_1__["Bang"])) this.state.instance = data;
...
//# sourceMappingURL=ba4aec43557d3a04a024.js.map