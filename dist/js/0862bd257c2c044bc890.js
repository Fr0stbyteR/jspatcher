...
function () {
  ...
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee4(faust) {
    var libDocs, primDocs, faustLib, allDocs, hoverProvider, tokensProvider, completionItemProvider;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 14:
            ...
            allDocs = _objectSpread({}, primDocs, {}, libDocs);
            hoverProvider = {
              provideHover: (model, position) => {
                var matched = matchDocKey(allDocs, model, position);
...
//# sourceMappingURL=0862bd257c2c044bc890.js.map