...
class DspSubPatcher extends _SubPatcher__WEBPACK_IMPORTED_MODULE_0__.default {
  constructor() {
    ...
    _defineProperty(this, "handlePatcherIOChanged", meta => {
      ...
      this.inletAudioConnections = new Array(this.inlets).fill(null).map((v, index) => ({
        node,
        index
      }));
      this.outletAudioConnections = new Array(this.outlets).fill(null).map((v, index) => ({
        node,
        index
      }));
...
_defineProperty(DspSubPatcher, "args", [{
  type: "string",
  optional: true,
  default: "",
...
//# sourceMappingURL=bdb2bb53c9588aa6e724.js.map