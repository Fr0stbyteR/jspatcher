  ...
  process(inputs, outputs, parameters) {
    ...
    for (var i = 0; i < input.length; i++) {
      ...
      if (bufferSize > windowSize) {
        ...
        Object(_utils__WEBPACK_IMPORTED_MODULE_0__["setBuffer"])(window, channel, $);
...
/*!***************************************!*\
  !*** ./src/core/objects/dsp/utils.ts ***!
  \***************************************/
/*! exports provided: energy, rms, zcr, setBuffer, getSubBuffer, fftw2Amp */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var setBuffer = (to, from, offsetTo, offsetFrom) => {
  ...
  var spilled = 0;
  var $to = Object(_utils_math__WEBPACK_IMPORTED_MODULE_0__["mod"])(offsetTo, toLength) || 0;
  var $from = Object(_utils_math__WEBPACK_IMPORTED_MODULE_0__["mod"])(offsetFrom, fromLength) || 0;
...
var getSubBuffer = (from, length, offset) => {
  var fromLength = from.length;
  var $ = Object(_utils_math__WEBPACK_IMPORTED_MODULE_0__["mod"])(offset, fromLength) || 0;
...
var fftw2Amp = from => {
  ...
  for (var i = 0; i < length / 2; i++) {
    ...
    amps[i] = Math.pow(real * real + imag * imag, 0.5) / length * 2.38328;
  }
...
/******/ });
//# sourceMappingURL=d656bfea3574349bf4de.worklet.js.map