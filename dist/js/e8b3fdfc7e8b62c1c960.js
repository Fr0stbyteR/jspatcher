"use strict";
(self["webpackChunkJSPatcher"] = self["webpackChunkJSPatcher"] || []).push([["src_core_objects_Gen_tsx"],{
...
GenLibOp.package = "Gen";
GenLibOp.author = "Fr0stbyteR";
GenLibOp.version = "1.0.0";
GenLibOp.description = "Gen Operator";
...
class Cycle extends GenLibOp {
  constructor() {
    super(...arguments);
    this._ = __spreadProps(__spreadValues({}, this._), { inlets: 1, outlets: 1, defaultArgs: [440] });
  }
  get symbol() {
    return [this.getProp("index") === "freq" ? "cycle" : "cycle_phase"];
  }
}
Cycle.description = "An interpolating oscillator that reads repeatedly through one cycle of a sine wave. By default it is driven by a frequency input, but if the @index attribute is set to 'phase', it can be driven by a phase input instead.";
Cycle.props = __spreadProps(__spreadValues({}, _Faust__WEBPACK_IMPORTED_MODULE_1__.LibOp.props), {
  index: {
    type: "enum",
    enums: ["freq", "phase"],
    default: "freq",
...
class Interp extends GenLibOp {
  constructor() {
    super(...arguments);
    this._ = __spreadProps(__spreadValues({}, this._), { inlets: 3, outlets: 1, defaultArgs: [440] });
    this.handleUpdate = (e) => {
      if ("mode" in e.props) {
        const { mode } = e.props;
...
Interp.description = "An interpolating oscillator that reads repeatedly through one cycle of a sine wave. By default it is driven by a frequency input, but if the @index attribute is set to 'phase', it can be driven by a phase input instead.";
Interp.props = __spreadProps(__spreadValues({}, _Faust__WEBPACK_IMPORTED_MODULE_1__.LibOp.props), {
  mode: {
    type: "enum",
...
class Rec extends _Faust__WEBPACK_IMPORTED_MODULE_1__.Rec {
  constructor() {
    super(...arguments);
    this._ = __spreadProps(__spreadValues({}, this._), { inlets: 2, outlets: 1 });
...
Rec.package = "Gen";
Rec.description = "x-samples delay";
Rec.args = [{
  type: "number",
  optional: true,
  default: 48e3,
...
const genOps = {
  comment: _base_index_jspatpkg__WEBPACK_IMPORTED_MODULE_0__.comment,
...
const opMap = {
  ...
  dsp: {
    ...
    MStosamps: { symbol: ["mstosamps"], inlets: 1, defaultArgs: [1e3], desc: "Convert period in milliseconds to samples" },
...
for (const category in opMap) {
  for (const name in opMap[category]) {
    ...
    const Op = (_a = class extends GenLibOp {
      constructor() {
        super(...arguments);
        this._ = __spreadProps(__spreadValues({}, this._), { inlets, outlets: outlets || 1, defaultArgs: defaultArgs || new Array(inlets).fill(0) });
        this.reverseApply = !applyArgsFromStart;
      }
      static get _name() {
        return name;
      }
    ...
    }, _a.description = desc, _a);
    genOps[name] = Op;
    if (typeof symbol === "string")
      genOps[symbol] = Op;
    else
      symbol.forEach((s) => genOps[s] = Op);
  }
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (genOps);
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_Gen_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../../node_modules/css-loader/dist/cjs.js!../../../node_modules/sass-loader/dist/cjs.js!./Gen.scss */ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/core/objects/Gen.scss");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_Gen_scss__WEBPACK_IMPORTED_MODULE_6__["default"], options);




       /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_Gen_scss__WEBPACK_IMPORTED_MODULE_6__["default"] && _node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_Gen_scss__WEBPACK_IMPORTED_MODULE_6__["default"].locals ? _node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_Gen_scss__WEBPACK_IMPORTED_MODULE_6__["default"].locals : undefined);


/***/ })

}]);
//# sourceMappingURL=e8b3fdfc7e8b62c1c960.js.map