(self["webpackChunkJSPatcher"] = self["webpackChunkJSPatcher"] || []).push([["src_core_objects_importer_New_tsx"],{
...
class New extends _Base__WEBPACK_IMPORTED_MODULE_1__.DefaultObject {
  ...
  subscribe() {
    ...
    this.on("inlet", (_ref) => {
      ...
      if (inlet === 0) {
        if (!(0,_Base__WEBPACK_IMPORTED_MODULE_1__.isBang)(data)) this.state.inputs[inlet] = data;
...
//# sourceMappingURL=eeb866f1556998bbc8d0.js.map