...
/* harmony import */ var _Faust2MD__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Faust2MD */ "./src/misc/monaco-faust/Faust2MD.ts");
...
_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(Faust2Doc, "REGEX_DEF_LIB", /\b(\w+)\s*=\s*library\("(.+)"\);/);

_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(Faust2Doc, "REGEX_DEF_IMP", /\bimport\("(.+)"\);/);

_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(Faust2Doc, "REGEX_FUNC_NAME", /`.*?([\w[\]|]+)`/);

_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(Faust2Doc, "REGEX_FUNC_NAME_COND", /\[(.+?)(\|.+?)*?]/);
...
//# sourceMappingURL=7fe8485256c65a208091.js.map