...
class Plugin extends _Base__WEBPACK_IMPORTED_MODULE_0__.BaseObject {
  constructor() {
    ...
    _defineProperty(this, "handleDestroy", () => {
      ...
      if (plugin) {
        var _this$state$children;

        plugin.audioNode.destroy();
        if ((_this$state$children = this.state.children) !== null && _this$state$children !== void 0 && _this$state$children[0]) plugin.destroyGui(this.state.children[0]);
      }
    });
...
//# sourceMappingURL=48fdaba970d1a187b857.js.map