...
class Analyser extends _AudioNode__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  subscribe() {
    ...
    this.on("inlet", (_ref) => {
      ...
      if (inlet === 0) {
        if (data instanceof _Base__WEBPACK_IMPORTED_MODULE_1__["Bang"]) this.outlet(5, this.node);
      } else if (inlet === 5) {
...
class JSPAudioNode extends _Base__WEBPACK_IMPORTED_MODULE_0__["DefaultAudioObject"] {
  set node(nodeIn) {
...
class Biquad extends _AudioNode__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  subscribe() {
    ...
    this.on("inlet", (_ref) => {
      ...
      if (inlet === 0) {
        if (data instanceof _Base__WEBPACK_IMPORTED_MODULE_1__["Bang"]) this.outlet(1, this.node);
      } else if (inlet === 5) {
...
class Constant extends _AudioNode__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    ...
    _defineProperty(this, "inletConnections", [null, {
...
class Destination extends _AudioNode__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  subscribe() {
    ...
    this.on("inlet", (_ref) => {
      ...
      if (inlet === 0) {
        if (data instanceof _Base__WEBPACK_IMPORTED_MODULE_1__["Bang"]) this.outlet(0, this.node);
      }
    });
  }
    ...
    this.on("inlet", (_ref2) => {
      ...
      if (inlet === 0) {
        if (typeof data === "number") {
          ...
          this.outlet(1, this.node);
        } else if (data instanceof _Base__WEBPACK_IMPORTED_MODULE_1__["Bang"]) this.outlet(1, this.node);
      }
    });
  }
  ...
  subscribe() {
    ...
    this.on("inlet", (_ref2) => {
      ...
      if (inlet === 0) {
        ...
        } else if (data instanceof _Base__WEBPACK_IMPORTED_MODULE_1__["Bang"]) this.outlet(this.outlets - 1, this.node);
      }
    });
  }
...
class StreamDest extends _AudioNode__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  subscribe() {
    ...
    this.on("inlet", (_ref) => {
      ...
      if (inlet === 0) {
        if (data instanceof _Base__WEBPACK_IMPORTED_MODULE_1__["Bang"]) this.outletAll([this.node, this.node.stream]);
      }
    });
  }
...
class Plugin extends _Base__WEBPACK_IMPORTED_MODULE_0__["BaseAudioObject"] {
  constructor() {
    super(...arguments);
...
class audioContext extends _Base__WEBPACK_IMPORTED_MODULE_0__["DefaultObject"] {
  ...
  subscribe() {
    ...
    this.on("inlet", (_ref) => {
      ...
      if (inlet === 0) {
        if (data instanceof _Base__WEBPACK_IMPORTED_MODULE_0__["Bang"]) this.outlet(0, this.patcher.audioCtx);
      }
    });
  }
...
class audioWorklet extends _Base__WEBPACK_IMPORTED_MODULE_0__["DefaultObject"] {
  constructor() {
    ...
    _defineProperty(this, "handleInlet", async (_ref) => {
      ...
      if (inlet === 0) {
        if (data instanceof _Base__WEBPACK_IMPORTED_MODULE_0__["Bang"]) this.outlet(0, this.audioWorklet);
      } else if (inlet === 1) {
...
//# sourceMappingURL=e2079b1b7c71251d444c.js.map