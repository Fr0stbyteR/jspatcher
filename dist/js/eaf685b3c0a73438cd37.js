...
var MonacoDiffEditor = /** @class */ (function (_super) {
    ...
    MonacoDiffEditor.prototype.render = function () {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { ref: this.assignRef, style: style, className: "react-monaco-editor-container" }));
    };
    MonacoDiffEditor.propTypes = {
        width: prop_types__WEBPACK_IMPORTED_MODULE_3__.oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_3__.string, prop_types__WEBPACK_IMPORTED_MODULE_3__.number]),
        height: prop_types__WEBPACK_IMPORTED_MODULE_3__.oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_3__.string, prop_types__WEBPACK_IMPORTED_MODULE_3__.number]),
        original: prop_types__WEBPACK_IMPORTED_MODULE_3__.string,
        value: prop_types__WEBPACK_IMPORTED_MODULE_3__.string,
        defaultValue: prop_types__WEBPACK_IMPORTED_MODULE_3__.string,
        language: prop_types__WEBPACK_IMPORTED_MODULE_3__.string,
        theme: prop_types__WEBPACK_IMPORTED_MODULE_3__.string,
        options: prop_types__WEBPACK_IMPORTED_MODULE_3__.object,
        overrideServices: prop_types__WEBPACK_IMPORTED_MODULE_3__.object,
        editorDidMount: prop_types__WEBPACK_IMPORTED_MODULE_3__.func,
        editorWillMount: prop_types__WEBPACK_IMPORTED_MODULE_3__.func,
...
var MonacoEditor = /** @class */ (function (_super) {
    ...
    MonacoEditor.prototype.initMonaco = function () {
        ...
        if (this.containerElement) {
            ...
            this.editor = monaco_editor_esm_vs_editor_editor_api__WEBPACK_IMPORTED_MODULE_0__.editor.create(this.containerElement, __assign(__assign(__assign({ value: value, language: language }, (className ? { extraEditorClassName: className } : {})), options), (theme ? { theme: theme } : {})), overrideServices);
            // After initializing monaco editor
            this.editorDidMount(this.editor);
        }
    };
...
//# sourceMappingURL=eaf685b3c0a73438cd37.js.map