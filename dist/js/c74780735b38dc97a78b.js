  ...
  constructor() {
    ...
    _defineProperty(this, "handleInlet", async (_ref) => {
      ...
      if (inlet === 0) {
        ...
        } else if ((0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.isMIDIEvent)(data)) {// if (this.state.node) this.state.node.onMidi(data);
...
class BufferUI extends _BaseUI__WEBPACK_IMPORTED_MODULE_5__.DefaultPopupUI {
  ...
  componentWillUnmount() {
    var _this$state$editor, _this$state$editor$of;

    (_this$state$editor = this.state.editor) === null || _this$state$editor === void 0 ? void 0 : (_this$state$editor$of = _this$state$editor.off) === null || _this$state$editor$of === void 0 ? void 0 : _this$state$editor$of.call(_this$state$editor, "changed", this.handleChanged);
  ...
  render() {
    ...
    }, this.state.editor ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_components_editors_audio_AudioEditorUI__WEBPACK_IMPORTED_MODULE_3__.default, {
...
//# sourceMappingURL=c74780735b38dc97a78b.js.map