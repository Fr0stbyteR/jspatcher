...
class Buffer extends _Base__WEBPACK_IMPORTED_MODULE_0__.DefaultObject {
  ...
  subscribe() {
    ...
    const unsubscribeItem = async () => {
      ...
      await ((_this$state$sharedIte2 = this.state.sharedItem) === null || _this$state$sharedIte2 === void 0 ? void 0 : _this$state$sharedIte2.removeObserver(this));
    };
...
//# sourceMappingURL=72f1c23ffc5bad1209db.js.map