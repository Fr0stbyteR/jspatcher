...
/* harmony import */ var _Faust2MD__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Faust2MD */ "./src/misc/monaco-faust/Faust2MD.ts");
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              depth = depthIn || 2;
              _context.next = 5;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(getFile(fileName));
            ...
            case 14:
              ...
              if (_Faust2MD__WEBPACK_IMPORTED_MODULE_1__["Faust2MD"].isComment(line)) {
                _context.next = 37;
                break;
              }
            ...
            case 21:
              ...
              lib = libs[j];
              _context.next = 25;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(_this.parse(lib.fileName, getFile, depth - 1, [...path, lib.namespace], doc));
            ...
            case 29:
              ...
              imp = imps[_j];
              _context.next = 33;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(_this.parse(imp, getFile, depth - 1, path, doc));
            ...
            case 37:
              ...
              if (idt === 0) idt = _Faust2MD__WEBPACK_IMPORTED_MODULE_1__["Faust2MD"].indentation(line); // we have to measure the indentation
              // check end of md-comment

              _endC$endS$endT = {
                endC: _Faust2MD__WEBPACK_IMPORTED_MODULE_1__["Faust2MD"].matchEndComment(line),
                endS: _Faust2MD__WEBPACK_IMPORTED_MODULE_1__["Faust2MD"].matchEndSection(line),
                endT: _Faust2MD__WEBPACK_IMPORTED_MODULE_1__["Faust2MD"].matchEndTitle(line)
              ...
              else strBuffer += _Faust2MD__WEBPACK_IMPORTED_MODULE_1__["Faust2MD"].outdent(line, idt) + "\n";
            ...
            case 43:
              ...
              _c$s$t = {
                c: _Faust2MD__WEBPACK_IMPORTED_MODULE_1__["Faust2MD"].matchBeginComment(line),
                s: _Faust2MD__WEBPACK_IMPORTED_MODULE_1__["Faust2MD"].matchBeginSection(line),
                t: _Faust2MD__WEBPACK_IMPORTED_MODULE_1__["Faust2MD"].matchBeginTitle(line)
...
/* harmony import */ var monaco_editor_esm_vs_editor_editor_api__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(monaco_editor_esm_vs_editor_editor_api__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _Faust2Doc__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Faust2Doc */ "./src/misc/monaco-faust/Faust2Doc.ts");
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          _context.next = 5;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.awrap(fetch(libPath + fileName));
...
var matchDocKey = (doc, model, position) => {
  ...
  while (column$ - 2 >= 0 && line[column$ - 1] === ".") {
    column$ -= 2;
    var prefixWord = model.getWordAtPosition(new monaco_editor_esm_vs_editor_editor_api__WEBPACK_IMPORTED_MODULE_2__["Position"](line$, column$));
  ...
  while (nameArray.length) {
    ...
    if (e) {
      return {
        nameArray,
        name: _name,
        range: new monaco_editor_esm_vs_editor_editor_api__WEBPACK_IMPORTED_MODULE_2__["Range"](line$, column$ + 1, line$, wordAtPosition.endColumn),
        doc: e
      };
    }
    ...
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.prev = 2;
          _context4.next = 5;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.awrap(_Faust2Doc__WEBPACK_IMPORTED_MODULE_3__["Faust2Doc"].parse("stdfaust.lib", fileName => {
        ...
        case 5:
          ...
          _context4.next = 8;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.awrap(_Faust2Doc__WEBPACK_IMPORTED_MODULE_3__["Faust2Doc"].parse("primitives.lib", fileName => {
          ...
          completionItemProvider = {
            provideCompletionItems: () => {
              ...
              [...faustKeywords, ...faustFunctions, ...faustLib].forEach(e => {
                suggestions.push({
                  label: e,
                  kind: monaco_editor_esm_vs_editor_editor_api__WEBPACK_IMPORTED_MODULE_2__["languages"].CompletionItemKind.Text,
                  insertText: e,
                  range: null
                });
              });
...
//# sourceMappingURL=debc904b18bc46cf76a1.js.map