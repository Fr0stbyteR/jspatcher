...
class PackageManager extends _utils_TypedEventEmitter__WEBPACK_IMPORTED_MODULE_0__.default {
  ...
  init() {
    this.pkg = _objectSpread({}, this.global[this.mode]);
...
class Getter extends _ImportedObject__WEBPACK_IMPORTED_MODULE_0__.default {
  constructor() {
    ...
    _defineProperty(this, "handleInlet", _ref => {
      ...
      if (inlet === 0) {
        if (!(0,_base_Bang__WEBPACK_IMPORTED_MODULE_1__.isBang)(data)) this.state.instance = data;
        if (this.execute()) this.output();
      }
    });

    _defineProperty(this, "callback", () => this.outletAll([this.state.result, this.state.instance]));
  }
...
class Method extends _ImportedObject__WEBPACK_IMPORTED_MODULE_0__.default {
  ...
  execute() {
    ...
    try {
      this.state.result = fn.call(this.state.instance, ...(this.getProp("spreadArgs") ? this.state.inputs.reduce((acc, cur) => [...acc, ...cur], []) : this.state.inputs));
      return true;
    } catch (e) {
      this.error(e);
      return false;
...
class New extends _base_BaseObject__WEBPACK_IMPORTED_MODULE_1__.default {
  ...
  subscribe() {
    ...
    this.on("inlet", _ref => {
      ...
      if (inlet === 0) {
        if (!(0,_base_Bang__WEBPACK_IMPORTED_MODULE_2__.isBang)(data)) this.state.inputs[inlet] = data;
        if (this.execute()) this.output();
      } else {
  ...
  execute() {
    ...
    try {
      this.state.result = new Fn(...(this.getProp("spreadArgs") ? this.state.inputs.reduce((acc, cur) => [...acc, ...cur], []) : this.state.inputs));
      return true;
    } catch (e) {
      this.error(e);
      return false;
  ...
  constructor() {
    ...
    _defineProperty(this, "handleInlet", _ref => {
      ...
      if (inlet === 0) {
        ...
        this.outletAll([result, this.state.instance]);
      } else if (inlet === 1) {
        try {
...
class StaticGetter extends _Getter__WEBPACK_IMPORTED_MODULE_0__.default {
  constructor() {
    ...
    _defineProperty(this, "callback", () => this.outlet(0, this.state.result));
  }
...
class StaticMethod extends _Method__WEBPACK_IMPORTED_MODULE_0__.default {
  ...
  execute() {
    ...
    try {
      this.state.result = fn(...(this.getProp("spreadArgs") ? this.state.inputs.reduce((acc, cur) => [...acc, ...cur], []) : this.state.inputs));
      return true;
    } catch (e) {
      this.error(e);
      return false;
...
class Patcher extends _file_FileInstance__WEBPACK_IMPORTED_MODULE_0__.default {
  ...
  async load(patcherIn, modeIn) {
    ...
    if (mode === "js" && this.props.dependencies) {
      ...
      try {
        ...
        await this.env.taskMgr.newTask(this, "".concat(((_this$file3 = this.file) === null || _this$file3 === void 0 ? void 0 : _this$file3.name) || "", " Loading dependencies"), async onUpdate => {
  ...
  async getPatcherNode() {
    if (this.props.mode === "jsaw" && this.env.thread === "main") {
      ...
      this.state.patcherNode = new PatcherNode(this.audioCtx, {
        env: this.env,
        instanceId: this.id,
        fileId: (_this$file4 = this.file) === null || _this$file4 === void 0 ? void 0 : _this$file4.id,
  ...
  inputAudio(input, index, sample) {
    this.emit("audioInput", {
      input,
      index,
      sample
    });
  ...
  inputParam(param, index, sample) {
    this.emit("paramInput", {
      param,
      index,
      sample
    });
  ...
  outputAudio(output, index, sample) {
    this.emit("audioOutput", {
      output,
      index,
      sample
    });
...
/******/ })()
;
//# sourceMappingURL=7e971f7eda4062696834.worklet.js.map