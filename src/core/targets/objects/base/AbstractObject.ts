...
import Line from "../../patcher/TargetLine";
import type Box from "../../patcher/Box";
import type Patcher from "../../patcher/Patcher";
import type { ProjectItemType, TempItemByType, SharedItemByType, TempItemType } from "../../../types";
...
// TODO -- need the concrete types this will pass
// also, add message to the regular patcher
export type TMetaType = "anything" | "signal" | "object" | "number" | "boolean" | "string" | "function" | "bang" | "color" | "enum";
export interface IInletOutletMeta {
    type: TMetaType;
    enums?: string[];
    varLength?: boolean;
    description: string;
}
export type IInletOutletsMeta = IInletOutletMeta[];
...
export interface IJSPatcherObjectMeta<P extends Record<string, any> = Record<string, any>> {
    ...
    version: string;
    description: string;
    ios: IInletOutletsMeta;
    args: IArgsMeta;
    props: IPropsMeta<P>;
    isPatcherInlet: "data" | "parameter" | false;
    isPatcherOutlet: "data" | false;
}
...
export type Data<T> = T extends IJSPatcherObject<infer D, any, any, any, any, any, any> ? D : never;
export type State<T> = T extends IJSPatcherObject<any, infer S, any, any, any, any, any> ? S : never;
export type InputsOutputs<T> = T extends IJSPatcherObject<any, any, infer IO, any, any, any, any> ? IO : never;
export type Args<T> = T extends IJSPatcherObject<any, any, any, infer A, any, any, any> ? A : never;
export type Props<T> = T extends IJSPatcherObject<any, any, any, any, infer P, any, any> ? P : never;
export type UIState<T> = T extends IJSPatcherObject<any, any, any, any, any, infer U, any> ? U : never;
export type EventMap<T> = T extends IJSPatcherObject<any, any, any, any, any, any, infer E> ? E : never;
...
export type JSPatcherObjectEventMap<D, S, I extends any[], A extends any[], P, U, E> = {
    ...
    "connectedIo": { io: number; srcBoxId: string; srcIo: number; lineId: string };
    "disconnectedIo": { io: number; srcBoxId: string; srcIo: number; lineId: string };
...
export interface IJSPatcherObject<
    ...
    P extends {} = {},
    U extends {} = {},
    E extends Partial<JSPatcherObjectEventMap<D, S, IO, A, P, U, {}>> & Record<string, any> = {}
> extends TypedEventEmitter<JSPatcherObjectEventMap<D, S, IO, A, P, U, E>> {
    /** Should be true */
    ...
    // called when I/Os are connected or disconnected
    connectedIo(io: number, srcBoxId: string, srcIo: number, lineId: string): void;
    disconnectedIo(io: number, srcBoxId: string, srcIo: number, lineId: string): void;
...
export interface AnyJSPatcherObject extends IJSPatcherObject<Record<string, any>, Record<string, any>, any[], any[], Record<string, any>, Record<string, any>, Record<string, any>> {}
...
export default abstract class AbstractObject<
    ...
    U extends {} = {},
    E extends Partial<JSPatcherObjectEventMap<D, S, IO, A, P, U, {}>> & Record<string, any> = {}
> extends TypedEventEmitter<JSPatcherObjectEventMap<D, S, IO, A, P, U, E>> implements IJSPatcherObject<D, S, IO, A, P, U, E> {
    ...
    static description = "";
    static ios: IInletOutletsMeta = [];
    static args: IArgsMeta = [];
    static props: IPropsMeta = {};
    static isPatcherInlet: "data" | false = false;
    static isPatcherOutlet: "data" | false = false;
    ...
    // }
    connectedIo(io: number, srcBoxId: string, srcIo: number, lineId: string) {
        this.emit("connectedIo", { io, srcBoxId, srcIo, lineId });
    }
    disconnectedIo(io: number, srcBoxId: string, srcIo: number, lineId: string) {
        this.emit("disconnectedIo", { io, srcBoxId, srcIo, lineId });
    }
    post(data: any) {
