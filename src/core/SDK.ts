...
import TextEditorUI from "../components/editors/TextEditorUI";
...
export interface IJSPatcherSDK {
    ...
    readonly TempTextFile?: typeof TempTextFile;
    readonly PatcherText?: typeof PatcherText;
    readonly TextEditor?: typeof TextEditor;
    readonly TextEditorUI?: typeof TextEditorUI;
    readonly Patcher: typeof Patcher;
    readonly PatcherEditor?: typeof PatcherEditor;
    readonly PatcherEditorUI?: typeof PatcherEditorUI;
...
export default class JSPatcherSDK implements IJSPatcherSDK {
    ...
    readonly PatcherText = PatcherText;
    readonly TextEditor = TextEditor;
    readonly TextEditorUI = TextEditorUI;
    readonly TempTextFile = TempTextFile;
    readonly Patcher = Patcher;
    readonly PatcherEditor = PatcherEditor;
    readonly PatcherEditorUI = PatcherEditorUI;
    readonly Box = Box;
    readonly Line = Line;
