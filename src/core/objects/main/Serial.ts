import { IArgsMeta, IInletsMeta, IOutletsMeta, IPropsMeta } from "../base/AbstractObject";
...
export default class Serial extends DefaultObject<{}, {}, [any], [string | Uint8Array, SerialPort], [number?], P> {
    ...
    static props: IPropsMeta<P> = {
        mode: {
            ...
            default: "text",
            enums: ["text", "raw"],
            description: "I/O format, raw for Uint8Array, text for UTF-8 decoded text"
        },
        dataBits: {
            type: "enum",
            default: 8,
