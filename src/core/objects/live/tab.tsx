...
type LiveTabAdditionalState = { inputBuffer: string };
class LiveTabUI extends LiveUI<LiveTab, LiveTabProps & LiveTabAdditionalState> {
    state: LiveTabProps & LiveUIState & LiveTabAdditionalState = {
        ...this.state,
